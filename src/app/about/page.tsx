                ...
                <div className='w-full max-w-4xl mx-auto px-6 py-8'>
                        ...
                        <div className='grid md:grid-cols-12 gap-12 items-start'>
                            ...
                            <div className='md:col-span-8 text-left'>
                                <p className='text-lg md:text-xl text-zinc-300 leading-relaxed mb-6'>
                                    Analista de sistemas especializado em
                                    Quality Assurance com 2 anos de experiência
                                    sólida em projetos de tecnologia e automação
                                    de testes.
                                </p>
                                <p className='text-lg md:text-xl text-zinc-300 leading-relaxed mb-6'>
                                    Experiência prática na implementação de
                                    testes automatizados, integração com
                                    pipelines de CI/CD e desenvolvimento de
                                    estratégias de qualidade que garantem
                                    entregas confiáveis.
                                </p>
                                <p className='text-lg md:text-xl text-zinc-300 leading-relaxed'>
                                    Busco oportunidades para crescer
                                    profissionalmente em empresas que valorizam
                                    qualidade de software e inovação
                                    tecnológica, aplicando meus conhecimentos em
                                    automação de testes e metodologias ágeis.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className='bg-zinc-900/50 backdrop-blur-sm border border-zinc-500 rounded-lg p-8 mb-12 animate-fade-in'>
                        ...
                        <p className='text-zinc-300 leading-relaxed mb-6'>
                            <strong className='text-zinc-200'>2 anos</strong> de
                            experiência sólida em projetos de tecnologia, com
                            foco em automação de testes e garantia de qualidade.
                            Especialista em criar estratégias eficientes que
                            impactam positivamente na qualidade do produto
                            final.
                        </p>
                        <p className='text-zinc-300 leading-relaxed mb-6'>
                            ...
                            , integração com pipelines de CI/CD e implementação
                            de processos de qualidade em ambientes ágeis com
                            entregas contínuas.
                        </p>
                        <p className='text-zinc-300 leading-relaxed'>
                            ...
                            Implementação de suites de testes automatizados,
                            otimização de processos de QA e contribuição
                            significativa para redução de bugs em produção
                            através de testes eficientes.
                        </p>
                    </div>
                            ...
                            <div className='space-y-4'>
                                <div className='flex gap-3'>
                                    ...
                                    <p className='text-sm text-zinc-300'>
                                        <strong>Automação de Testes:</strong>{' '}
                                        Cypress - Desenvolvimento de testes
                                        automatizados integrados ao CI/CD
                                    </p>
                                </div>
                                ...
                                <div className='flex gap-3'>
                                    <CheckCircle className='w-5 h-5 text-zinc-200 flex-shrink-0 mt-0.5' />
                                    <p className='text-sm text-zinc-300'>
                                        <strong>Testes de API:</strong> Postman,
                                        Swagger - Validação e documentação de
                                        APIs REST
                                    </p>
                                </div>
                                ...
                                <div className='flex gap-3'>
                                    <CheckCircle className='w-5 h-5 text-zinc-200 flex-shrink-0 mt-0.5' />
                                    <p className='text-sm text-zinc-300'>
                                        <strong>DevOps & CI/CD:</strong> Git
                                        Actions, Git, Rancher - Integração e
                                        deployment contínuo
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className='space-y-4'>
                                <div className='flex gap-3'>
                                    ...
                                    <p className='text-sm text-zinc-300'>
                                        ...
                                        JavaScript - Programação e scripting
                                ...
                                <div className='flex gap-3'>
                                    ...
                                    <p className='text-sm text-zinc-300'>
                                        ...
                                        Experiência em ambientes Scrum e Kanban
                                ...
                                <div className='flex gap-3'>
                                    ...
                                    <p className='text-sm text-zinc-300'>
                                        ...
                                        Definição de processos e padrões para
                    ...
                    <div className='text-left md:text-center bg-zinc-900/50 backdrop-blur-sm border border-zinc-500 rounded-lg p-8 animate-fade-in'>
                        ...
                        <p className='text-zinc-300 mb-4'>
                            Profissional dedicado e em constante aprendizado,
                            buscando crescimento e oportunidades de contribuir
                            com projetos desafiadores.
                        </p>
                        <p className='text-zinc-300 mb-8'>
                            Estou em busca de oportunidades onde possa aplicar e
                            expandir meus conhecimentos em QA, contribuindo para
                            o desenvolvimento de produtos digitais de alta
                            qualidade.
                        </p>
