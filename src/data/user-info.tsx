...
import { IoHardwareChip, IoLogoVercel } from 'react-icons/io5'
...
export const courses = [
    ...
    },
    {
        ...
        institution: 'Udemy',
        describe:
            'Curso completo de SQL que aborda desde os fundamentos até conceitos avançados de bancos de dados relacionais, utilizando MySQL. Inclui gerenciamento de tabelas, comandos CRUD, JOINs, subqueries, funções agregadas, normalização, diagrama ER e um projeto final com PHP e MySQL.',
